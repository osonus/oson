 ...
 * @author Jesse Wilson
 */
public final class JavaSerializationTest extends TestCaseBase {
  ...
  public void testMapIsSerializable() throws Exception {
    ...
    assertEquals(Arrays.asList("a", "b", "c"), new ArrayList<String>(serialized.keySet()));
  }

  public void testListIsSerializable() throws Exception {
    Type type = new TypeToken<List<String>>() {}.getType();
    List<String> list = oson.fromJson("[\"a\",\"b\",\"c\"]", type);
