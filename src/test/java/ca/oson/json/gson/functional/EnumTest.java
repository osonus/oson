...
//  }
  ...
  public void testTopLevelEnumSerialization() throws Exception {
    String result = oson.toJson(MyEnum.VALUE1);
    assertEquals(MyEnum.VALUE1.toString(), result);
  }

  public void testTopLevelEnumDeserialization() throws Exception {
    MyEnum result = oson.fromJson('"' + MyEnum.VALUE1.toString() + '"', MyEnum.class);
  ...
  public void testCollectionOfEnumsSerialization() {
    ...
    String actualJson = oson.toJson(target);
    assertEquals(expectedJson, actualJson);
    actualJson = oson.toJson(target, type);
    assertEquals(expectedJson, actualJson);
  }
  ...
  public void testCollectionOfEnumsDeserialization() {
    ...
    Collection<MyEnum> target = oson.clearAll().fromJson(json, type);
    assertTrue(target.contains(MyEnum.VALUE1));
    assertTrue(target.contains(MyEnum.VALUE2));
  }
  ...
  public void testClassWithEnumFieldDeserialization() throws Exception {
    ...
    ClassWithEnumFields target = oson.fromJson(json, ClassWithEnumFields.class);
  ...
  public void testEnumSubclass() {
    ...
    assertEquals("ROCK", oson.toJson(Roshambo.ROCK));
    assertEquals("[\"ROCK\",\"PAPER\",\"SCISSORS\"]", oson.toJson(EnumSet.allOf(Roshambo.class)));
    assertEquals(Roshambo.ROCK, oson.fromJson("\"ROCK\"", Roshambo.class));
    
    Set<Roshambo> set = oson.fromJson("[\"ROCK\",\"PAPER\",\"SCISSORS\"]", new TypeToken<Set<Roshambo>>() {}.getType());
    
    assertEquals(EnumSet.allOf(Roshambo.class), set);
  }
...
//        .create();
    ...
    Function f = (Object p) -> {
    	Roshambo r = (Roshambo)p;
    	return "123" + r.name();};
    	
    Function d = (Object p) -> p.toString().substring(3);
    	
    assertEquals("123ROCK", oson.ser(Roshambo.class, f).des(Roshambo.class, d).toJson(Roshambo.ROCK));
    assertEquals("[\"123ROCK\",\"123PAPER\",\"123SCISSORS\"]", oson.toJson(EnumSet.allOf(Roshambo.class)));
    assertEquals(Roshambo.ROCK, oson.fromJson("\"123ROCK\"", Roshambo.class));
    assertEquals(EnumSet.allOf(Roshambo.class),
        oson.fromJson("[\"123ROCK\",\"123PAPER\",\"123SCISSORS\"]", new TypeToken<Set<Roshambo>>() {}.getType()));
  }
  ...
  public void testEnumSubclassAsParameterizedType() {
    ...
    Collection<Roshambo> actualJsonList = oson.fromJson(json, collectionType);
  ...
  public void testEnumCaseMapping() {
    assertEquals(Gender.MALE, oson.fromJson("\"boy\"", Gender.class));
    assertEquals("boy", oson.toJson(Gender.MALE, Gender.class));
  }

  public void testEnumSet() {
    EnumSet<Roshambo> foo = EnumSet.of(Roshambo.ROCK, Roshambo.PAPER);
    String json = oson.toJson(foo);
    Type type = new TypeToken<EnumSet<Roshambo>>() {}.getType();
    EnumSet<Roshambo> bar = oson.fromJson(json, type);
