 ...
 * @author Joel Leitch
 */
public class ExclusionStrategyFunctionalTest extends TestCaseBase {
  ...
  public void testExclusionStrategySerialization() throws Exception {
    ...
    String json = oson.setIgnore(String.class, true).ignoreFieldsWithAnnotation(Foo.class).toJson(src);
  ...
  public void testExclusionStrategySerializationDoesNotImpactDeserialization() {
    ...
    //Gson gson = createGson(new MyExclusionStrategy(String.class), true);
    SampleObjectForTest value = oson.fromJson(json, SampleObjectForTest.class);
  ...
  public void testExclusionStrategyDeserialization() throws Exception {
    ...
    SampleObjectForTest target = oson.setIgnore(String.class, true).ignoreFieldsWithAnnotation(Foo.class).fromJson(json.toString(), SampleObjectForTest.class);
  ...
  public void testExclusionStrategyWithMode() throws Exception {
    ...
    SampleObjectForTest target = oson.ignoreFieldsWithAnnotation(Foo.class).setIgnore(String.class, true).fromJson(json.toString(), SampleObjectForTest.class);
  ...
  public void testExcludeTopLevelClassDeserialization() {
    Gson gson = new GsonBuilder()
        ...
        .create();
    String json = "{\"annotatedField\":1,\"stringField\":\"x\",\"longField\":2}";
    SampleObjectForTest value = oson.setIgnore(SampleObjectForTest.class, true).fromJson(json, SampleObjectForTest.class);
    assertNull(value);
  }
  ...
  public void testExcludeTopLevelClassDeserializationDoesNotImpactSerialization() {
    Gson gson = new GsonBuilder()
        .addDeserializationExclusionStrategy(EXCLUDE_SAMPLE_OBJECT_FOR_TEST)
        .create();
    String json = oson.toJson(new SampleObjectForTest(), SampleObjectForTest.class);
    assertTrue(json.contains("\"stringField\""));
    assertTrue(json.contains("\"annotatedField\""));
    assertTrue(json.contains("\"longField\""));
  }
