 ...
 * @author Joel Leitch
 */
public class ExposeFieldsTest extends TestCaseBase {
  ...
  public void testExposeAnnotationDeserialization() throws Exception {
    String json = "{a:3,b:40,d:20.0}";
    ClassWithExposedFields target = oson.useGsonExpose(true).fromJson(json, ClassWithExposedFields.class);
...
//  }
  ...
  public void testNoExposedFieldDeserialization() throws Exception {
    String json = "{a:4,b:5}";
    ClassWithNoExposedFields obj = oson.fromJson(json, ClassWithNoExposedFields.class);
  ...
  public void testExposedInterfaceFieldDeserialization() throws Exception {
    ...
    ClassWithInterfaceField obj = oson.setConstructor(SomeInterface.class, new SomeInterfaceInstanceCreator()).fromJson(json, ClassWithInterfaceField.class);
