...
import ca.oson.json.domain.TestTypes.ClassWithBaseArrayField;
import ca.oson.json.domain.TestTypes.ClassWithBaseCollectionField;
import ca.oson.json.domain.TestTypes.ClassWithBaseField;
import ca.oson.json.domain.TestTypes.Nested;
import ca.oson.json.domain.TestTypes.Sub;
 ...
 * @author Joel Leitch
 */
public class InheritanceTest extends TestCaseBase {
  private Gson gson;
  ...
  public void testSubClassSerialization() throws Exception {
    ...
    assertEquals(target.getExpectedJson(), oson.setClassMappers(new ClassMapper(Nested.class).setJsonValueFieldName("expectedJson")).toJson(target));
  }
  ...
  public void testSubClassDeserialization() throws Exception {
    ...
    SubTypeOfNested target = oson.fromJson(json, SubTypeOfNested.class);
  ...
  public void testBaseSerializedAsBaseWhenSpecifiedWithExplicitTypeForToJsonMethod() {
    Base base = new Sub();
    String json = oson.toJson(base, Base.class);
  ...
  public void testBaseSerializedAsSubWhenSpecifiedWithExplicitTypeForToJsonMethod() {
    Base base = new Sub();
    String json = oson.toJson(base, Sub.class);
    assertTrue(json.contains(Sub.SUB_NAME));
  }
  ...
  public void testSubInterfacesOfCollectionSerialization() throws Exception {
    ...
    assertEquals(target.getExpectedJson(), oson.setClassMappers(new ClassMapper(ClassWithSubInterfacesOfCollection.class).setJsonValueFieldName("expectedJson")).toJson(target));
  }
  ...
  public void testSubInterfacesOfCollectionDeserialization() throws Exception {
    String json = "{\"list\":[0,1,2,3],\"queue\":[0,1,2,3],\"set\":[0.1,0.2,0.3,0.4],"
        ...
        + "}";
    ClassWithSubInterfacesOfCollection target = 
      oson.fromJson(json, ClassWithSubInterfacesOfCollection.class);
