 ...
 */
public class InstanceCreatorTest extends TestCaseBase {
  ...
  public void testInstanceCreatorReturnsBaseType() {
    ...
    Base base = oson.fromJson(json, Base.class);
  ...
  public void testInstanceCreatorReturnsSubTypeForTopLevelObject() {
    ...
    Base base = oson.setConstructor(Base.class, new InstanceCreator<Base>() {
      @Override public Base createInstance(Type type) {
        return new Sub();
      }
  ...
  public void testInstanceCreatorReturnsSubTypeForField() {
    ...
    ClassWithBaseField target = oson.setConstructor(Base.class, new InstanceCreator<Base>() {
      @Override public Base createInstance(Type type) {
        return new Sub();
      }
    }).fromJson(json, ClassWithBaseField.class);
  ...
  public void testInstanceCreatorForCollectionType() {
    ...
    Gson gson = new GsonBuilder()
        ...
        .create();
    List<String> list = oson.fromJson("[\"a\"]", SubArrayList.class);
  ...
  public void testInstanceCreatorForParametrizedType() throws Exception {
    ...
    SortedSet<String> set = oson.setConstructor(SortedSet.class, new InstanceCreator<SortedSet>() {
      @Override public SortedSet createInstance(Type type) {
        return new SubTreeSet();
      }
    }).fromJson("[\"a\"]", sortedSetType);
    assertEquals(set.first(), "a");
    assertEquals(SubTreeSet.class, set.getClass());

    set = oson.fromJson("[\"b\"]", SortedSet.class);
