 ...
 */
public class JavaUtilConcurrentAtomicTest extends TestCaseBase {
  private Gson gson;
  ...
  public void testAtomicBoolean() throws Exception {
    AtomicBoolean target = oson.fromJson("true", AtomicBoolean.class);
  ...
  public void testAtomicInteger() throws Exception {
    AtomicInteger target = oson.fromJson("10", AtomicInteger.class);
  ...
  public void testAtomicLong() throws Exception {
    AtomicLong target = oson.fromJson("10", AtomicLong.class);
    assertEquals(10, target.get());
    String json = oson.toJson(target);
    assertEquals("10", json);
  }
  ...
  public void testAtomicIntegerArray() throws Exception {
    AtomicIntegerArray target = oson.fromJson("[10, 13, 14]", AtomicIntegerArray.class);
