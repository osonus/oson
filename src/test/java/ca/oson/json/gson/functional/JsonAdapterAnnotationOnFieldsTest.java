 ...
 */
public final class JsonAdapterAnnotationOnFieldsTest extends TestCaseBase {
  public void testClassAnnotationAdapterTakesPrecedenceOverDefault() {
    Gson gson = new Gson();
    
    String json = oson.ser(User.class, (Object p) -> "UserClassAnnotationAdapter").toJson(new Computer(new User("Inderjeet Singh")));
    assertEquals("{\"user\":\"UserClassAnnotationAdapter\"}", json);
    
    Computer computer = oson.des(User.class, (Object p) -> {
    	return new User("UserClassAnnotationAdapter");
    }).fromJson("{'user':'Inderjeet Singh'}", Computer.class);
  ...
  public void testClassAnnotationAdapterFactoryTakesPrecedenceOverDefault() {
    ...
    String json = oson.ser(Part.class, (Object p) -> "GizmoPartTypeAdapterFactory").toJson(new Gizmo(new Part("Part")));
    assertEquals("{\"part\":\"GizmoPartTypeAdapterFactory\"}", json);
    
    
    Gizmo computer = oson.des(Part.class, (Object p) -> new Part("GizmoPartTypeAdapterFactory")).fromJson("{'part':'Part'}", Gizmo.class);
  ...
  public void testRegisteredTypeAdapterTakesPrecedenceOverClassAnnotationAdapter() {
    ...
    String json = oson.ser(User.class, (Object p) -> "RegisteredUserAdapter").toJson(new Computer(new User("Inderjeet Singh")));
  ...
  public void testFieldAnnotationTakesPrecedenceOverRegisteredTypeAdapter() {
    ...
    String json = oson.ser(Part.class, (Object p) -> "PartJsonFieldAnnotationAdapter").toJson(new Gadget(new Part("screen")));
    assertEquals("{\"part\":\"PartJsonFieldAnnotationAdapter\"}", json);
    
    
    Gadget gadget = oson.des(Part.class, (Object p) -> {
    	return new Part("PartJsonFieldAnnotationAdapter");
    }).fromJson("{'part':'screen'}", Gadget.class);
  ...
  public void testFieldAnnotationTakesPrecedenceOverClassAnnotation() {
    Gson gson = new Gson();
    String json = oson.ser(User.class, (Object p) -> "UserFieldAnnotationAdapter").toJson(new Computer2(new User("Inderjeet Singh")));
    assertEquals("{\"user\":\"UserFieldAnnotationAdapter\"}", json);
    
    
    Computer2 target = oson.des(User.class, (Object p) -> {
    	return new User("UserFieldAnnotationAdapter");
    }).fromJson("{'user':'Interjeet Singh'}", Computer2.class);
  ...
  public void testJsonAdapterInvokedOnlyForAnnotatedFields() {
    ...
    GadgetWithTwoParts gadget = oson.des(Part.class, (Object p) -> {
    	return new Part("PartJsonFieldAnnotationAdapter");
    }).fromJson(json, GadgetWithTwoParts.class);
  ...
  public void testJsonAdapterWrappedInNullSafeAsRequested() {
    ...
    GadgetWithOptionalPart gadget = oson.fromJson(fromJson, GadgetWithOptionalPart.class);
    assertNull(gadget.part);

    String toJson = oson.toJson(gadget);
  ...
  public void testNonPrimitiveFieldAnnotationTakesPrecedenceOverDefault() {
    Gson gson = new Gson();
    String json = oson.ser(Part.class, (Object p) -> "PartJsonFieldAnnotationAdapter").toJson(new GadgetWithOptionalPart(new Part("foo")));
    assertEquals("{\"part\":\"PartJsonFieldAnnotationAdapter\"}", json);
    
    GadgetWithOptionalPart gadget = oson.des(Part.class, (Object p) -> {
    	return new Part("PartJsonFieldAnnotationAdapter");
    }).fromJson("{'part':'foo'}", GadgetWithOptionalPart.class);
    assertEquals("PartJsonFieldAnnotationAdapter", gadget.part.name);
  }
  ...
  public void testPrimitiveFieldAnnotationTakesPrecedenceOverDefault() {
    ...
    String json = oson.ser(Long.class, (Long p) -> StringUtil.doublequote(p+"")).toJson(new GadgetWithPrimitivePart(42));
    assertEquals("{\"part\":\"42\"}", json);
    
    GadgetWithPrimitivePart gadget = oson.fromJson(json, GadgetWithPrimitivePart.class);
  ...
  public void testFieldAnnotationWorksForParameterizedType() {
    ...
    String json = oson.ser(Gizmo2.class, (Object p) -> "{\"part\":\"GizmoPartTypeAdapterFactory\"}").toJson(new Gizmo2(Arrays.asList(new Part("Part"))));
    assertEquals("{\"part\":\"GizmoPartTypeAdapterFactory\"}", json);

    Gizmo2 computer = oson.des(Gizmo2.class, (Object p) -> {
    	return new Gizmo2(Arrays.asList(new Part("GizmoPartTypeAdapterFactory")));
    }).fromJson("{'part':'Part'}", Gizmo2.class);
