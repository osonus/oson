...
public class MapAsArrayTypeAdapterTest extends TestCaseBase {
  ...
  public void disabled_testTwoTypesCollapseToOneSerialize() {
    ...
    try {
      oson.toJson(original, new TypeToken<Map<Number, String>>() {}.getType());
  ...
  public void testTwoTypesCollapseToOneDeserialize() {
    ...
    Object obj = oson.fromJson(s, new TypeToken<Map<Double, String>>() {}.getType());
...
//    }
  ...
  public void testMapWithTypeVariableSerialization() {
    ...
    String json = oson.useAttribute(false).toJson(map, type);
    // "{\"map\":[[{\"x\":2,\"y\":3},{\"x\":4,\"y\":5}]]}"
  ...
  public void testMapWithTypeVariableDeserialization() {
    ...
    Type type = new TypeToken<PointWithProperty<Point>>(){}.getType();
    PointWithProperty<Point> map = oson.fromJson(json, type);
    Map<Point, Point> map2 = map.map;
    Iterator<Point> iter = map2.keySet().iterator();
    Point key = iter.next();
    Point value = map2.get(key);
