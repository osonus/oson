...
//  }
  ...
  public void testMapDeserializationEmpty() {
    Type typeOfMap = new TypeToken<Map<String, Integer>>() {}.getType();
    Map<String, Integer> map = oson.fromJson("{}", typeOfMap);
  ...
  public void testMapDeserializationWithNullValue() {
    Type typeOfMap = new TypeToken<Map<String, Integer>>() {}.getType();
    Map<String, Integer> map = oson.fromJson("{\"abc\":null}", typeOfMap);
  ...
  public void testMapDeserializationWithNullKey() {
    Type typeOfMap = new TypeToken<Map<String, Integer>>() {}.getType();
    Map<String, Integer> map = oson.fromJson("{\"null\":123}", typeOfMap);
    assertEquals(1, map.size());
    assertEquals(123, map.get("null").intValue());
    assertNull(map.get(null));

    map = oson.fromJson("{null:123}", typeOfMap);
    assertEquals(1, map.size());
    assertEquals(123, map.get("null").intValue());
    assertNull(map.get(null));
  }
  ...
  public void testSortedMap() throws Exception {
    ...
    SortedMap<Integer, String> map = oson.fromJson("{\"123\":\"456\"}", typeOfMap);
    assertEquals(1, map.size());
    assertTrue(map.containsKey(123));
    assertEquals("456", map.get(123));
  }
  ...
  public void testConcurrentMap() throws Exception {
    ...
    ConcurrentMap<Integer, String> map = oson.fromJson("{\"123\":\"456\"}", typeOfMap);
    assertEquals(1, map.size());
    assertTrue(map.containsKey(123));
    assertEquals("456", map.get(123));
    String json = oson.toJson(map);
  ...
  public void testConcurrentHashMap() throws Exception {
    ...
    ConcurrentHashMap<Integer, String> map = oson.fromJson("{\"123\":\"456\"}", typeOfMap);
    assertEquals(1, map.size());
    assertTrue(map.containsKey(123));
    assertEquals("456", map.get(123));
    String json = oson.toJson(map);
  ...
  public void testConcurrentNavigableMap() throws Exception {
    ...
    ConcurrentNavigableMap<Integer, String> map = oson.fromJson("{\"123\":\"456\"}", typeOfMap);
    assertEquals(1, map.size());
    assertTrue(map.containsKey(123));
    assertEquals("456", map.get(123));
    String json = oson.toJson(map);
  ...
  public void testConcurrentSkipListMap() throws Exception {
    ...
    ConcurrentSkipListMap<Integer, String> map = oson.fromJson("{\"123\":\"456\"}", typeOfMap);
    assertEquals(1, map.size());
    assertTrue(map.containsKey(123));
    assertEquals("456", map.get(123));
    String json = oson.toJson(map);
  ...
  public void testParameterizedMapSubclassSerialization() {
    ...
    String json = oson.toJson(map, type);
  ...
  public void testMapSubclassSerialization() {
    MyMap map = new MyMap();
    map.put("a", "b");
    String json = oson.toJson(map, MyMap.class);
    assertTrue(json.contains("\"a\":\"b\""));
  }
  ...
  public void testMapStandardSubclassDeserialization() {
    ...
    LinkedHashMap<String, Integer> map = oson.fromJson(json, type);
  ...
  public void testCustomSerializerForSpecificMapType() {
    ...
    assertEquals("[1,2,3]", oson.ser(Map.class, (Object p) -> {Map map = (Map)p;
    return map.values();}).toJson(src, type));
  }
  ...
  public void testWriteMapsWithEmptyStringKey() {
    ...
    map.put("", true);
    assertEquals("{\"\":true}", oson.toJson(map));

  }

  public void testReadMapsWithEmptyStringKey() {
    Map<String, Boolean> map = oson.fromJson("{\"\":true}", new TypeToken<Map<String, Boolean>>() {}.getType());
...
//  }
  ...
  public void testGeneralMapField() throws Exception {
    ...
    assertEquals(expected, oson.toJson(map));
...
//        .create();
  ...
  public void testStringKeyDeserialization() {
    ...
    map.put("2,3", "a");
    map.put("5,7", "b");
    assertEquals(map, oson.fromJson(json, new TypeToken<Map<String, String>>() {}.getType()));
  }
  ...
  public void testNumberKeyDeserialization() {
    ...
    map.put(2.3, "a");
    map.put(5.7, "b");
    assertEquals(map, oson.fromJson(json, new TypeToken<Map<Double, String>>() {}.getType()));
  }
