 ...
 * @author Joel Leitch
 */
public class NullObjectAndFieldTest extends TestCaseBase {
  ...
  public void testTopLevelNullObjectDeserialization() throws Exception {
    Gson gson = gsonBuilder.create();
    String actual = oson.fromJson("null", String.class);
    assertNull(actual);
  }
  ...
  public void testExplicitDeserializationOfNulls() throws Exception {
    Gson gson = gsonBuilder.create();
    ClassWithObjects target = oson.fromJson("{\"bag\":null}", ClassWithObjects.class);
  ...
  public void testNullWrappedPrimitiveMemberDeserialization() {
    ...
    ClassWithNullWrappedPrimitive target = oson.fromJson(json, ClassWithNullWrappedPrimitive.class);
  ...
  public void testCustomSerializationOfNulls() {
    ...
    String actual = oson.ser(ClassWithObjects.class, (Object p) -> {JsonObject obj = new JsonObject();
    obj.add("bag", null);
    return obj.toString();}).toJson(target);
    String expected = "{\"bag\":null}";
    assertEquals(expected, actual);
  }
  ...
  public void testPrintPrintingArraysWithNulls() throws Exception {
    gsonBuilder = new GsonBuilder();
    Gson gson = gsonBuilder.create();
    String result = oson.toJson(new String[] { "1", null, "3" });
    assertEquals("[\"1\",null,\"3\"]", result);

    gson = gsonBuilder.serializeNulls().create();
    result = oson.toJson(new String[] { "1", null, "3" });
    assertEquals("[\"1\",null,\"3\"]", result);
  }
  ...
  public void testAbsentJsonElementsAreSetToNull() {
    ...
    ClassWithInitializedMembers target =
        oson.fromJson("{array:[1,2,3]}", ClassWithInitializedMembers.class);
  ...
  public void testExplicitNullSetsFieldToNullDuringDeserialization() {
    Gson gson = new Gson();
    String json = "{value:null}";
    ObjectWithField obj = oson.fromJson(json, ObjectWithField.class);
  ...
  public void testCustomTypeAdapterPassesNullSerialization() {
    ...
    target.value = "value1";
    String json = oson.ser(ObjectWithField.class, (Object p) -> "null").toJson(target);
  ...
  public void testCustomTypeAdapterPassesNullDesrialization() {
    ...
    ObjectWithField target = oson.des(ObjectWithField.class, (Object p) -> null).fromJson(json, ObjectWithField.class);
    assertNull(target);
  }
