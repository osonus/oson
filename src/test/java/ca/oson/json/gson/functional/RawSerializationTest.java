 ...
 */
public class RawSerializationTest extends TestCaseBase {
  ...
  public void testTwoLevelParameterizedObject() {
    ...
    assertEquals(expectedJson, json);
    // Ensure that serialization also works when the type is specified explicitly
    json = oson.toJson(bar, new TypeToken<Bar<Bar<Foo>>>(){}.getType());
    assertEquals(expectedJson, json);
  }
  ...
  public void testThreeLevelParameterizedObject() {
    ...
    assertEquals(expectedJson, json);
    // Ensure that serialization also works when the type is specified explicitly
    json = oson.toJson(bar, new TypeToken<Bar<Bar<Bar<Foo>>>>(){}.getType());
    assertEquals(expectedJson, json);
  }
