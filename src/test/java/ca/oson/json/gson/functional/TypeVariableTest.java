 ...
 * @author Joel Leitch
 */
public class TypeVariableTest extends TestCaseBase {
  ...
  public void testAdvancedTypeVariables() throws Exception {
    ...
    String json = oson.toJson(bar1);

    Bar bar2 = oson.fromJson(json, Bar.class);
...
//        json);
  ...
  public void testBasicTypeVariables() throws Exception {
    ...
    String json = oson.toJson(blue1);

    Blue blue2 = oson.fromJson(json, Blue.class);
