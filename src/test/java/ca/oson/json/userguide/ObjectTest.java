...
public class ObjectTest extends TestCaseBase {
	...
	public void testSerializeIgnoreObject() {
		...
		expected = "{\"title\":null,\"birthDate\":null,\"lastName\":null,\"age\":0,\"addressList\":null,\"firstName\":null,\"fvalue\":null,\"ch\":null,\"longValue\":null,\"shortValue\":0,\"aint\":null,\"intValue\":null,\"byte\":16,\"myInt\":12}";
		...
		expected = "{\"title\":null,\"birthDate\":null,\"age\":0,\"firstName\":null}";
		json = oson.serialize(obj);
		assertEquals(expected, json);
	...
	public void testSerializeDateTime() {
		...
		String expected = "{\"myDate\":\"2015/08/13 05:10:00\",\"sqlDate\":\"2013/05/28\",\"myTime\":\"2016-09-08 04:16:00.000\"}";
		...
		expected = "{\"myDate\":1439467800000,\"sqlDate\":\"Tuesday, May 28, 2013\",\"myTime\":\"September 8, 2016\"}";
		json = oson.serialize(obj);
		assertEquals(expected, json);
		...
		expected = "{\"myDate\":\"August 13, 2015\",\"sqlDate\":\"28/05/13 3:06:00 AM\",\"myTime\":\"September 8, 2016 4:16:00 PDT AM\"}";
		json = oson.serialize(obj);
		assertEquals(expected, json);
		...
		expected = "{\"myDate\":\"13 August 2015\",\"sqlDate\":\"28.05.13 03:06:00\",\"myTime\":\"8 settembre 2016 4.16.00 PDT\"}";
		json = oson.serialize(obj);
		assertEquals(expected, json);
	}
	...
	public void testSerializeOrderedPerson() {
		...
		expected = "{\"title\":null,\"birthDate\":null,\"firstName\":null,\"lastName\":null,\"age\":0,\"addressList\":null}";
		assertEquals(expected, json);
	}
